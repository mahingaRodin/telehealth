...
<View>
    ...
    <View style={styles.inputTop} className='m-auto flex flex-row justify-between'>
    <View style={styles.inputContainer}>
      ...
      >
        ...
        <Picker.Item label="Doctor" value="role1" />
        <Picker.Item label="Patient" value="role2" />
        <Picker.Item label="Anonymous" value="role3" />
      </Picker>
    </View>
  </View>
  ...
  fontFamily:'Montserrat-SemiBold',
    ...
    <TextInput placeholder='Re-Enter your password' className='w-[200px]'
    ...
    />
    <CustomText style={styles.label}>I accept <CustomText style={{color:'#2FAF64'}}>Terms </CustomText>and Conditions</CustomText>
  </View>
  </View>
  
</BlurView>
<View className='w-[80%] m-auto bottom-32'>
...
onPress={()=>router.navigate('/Authentication/Signin')}
  ...
  <View style={styles.signin}>
    ...
    <TouchableOpacity onPress={()=>router.navigate('/Authentication/Signin')} style={styles.touch}>
      <CustomText style={{fontFamily:'Montserrat-Medium',
        color:'#1f45a5',
        fontSize:17,
        bottom:10
