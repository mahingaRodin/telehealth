...
const Lab = () => {
  ...
  return (
    ...
    <View className='flex flex-row justify-between px-2 py-4'>
      <TouchableOpacity onPress={() => router.navigate('/LabTests/LabHome')}>
    ...
    <View className=''>
      <Text className='text-2xl text-green-500 font-bold m-auto'>
    ...
    <View className='pt-4'>
      <View style={styles.container} className='bg-gray-200'>
        ...
        >
          <Text className={`m-auto text-lg ${selectedTab === 'completed' ? 'text-green-500' : 'text-black'}`}>Completed</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.child2, selectedTab === 'pending' && styles.selectedChild]}
          onPress={() => setSelectedTab('pending')}
        >
          <Text className={`m-auto text-lg ${selectedTab === 'pending' ? 'text-green-500' : 'text-black'}`}>Pending</Text>
        </TouchableOpacity>
      </View>
      ...
      {selectedTab === 'completed' ? (
        <View>
          <View className='flex-row justify-between px-3 pt-4'>
            <Text className='text-xl font-bold' style={{ color: Colors.colors.Green }}>Blood Culture</Text>
            <View className='w-28 px-1 h-8 bg-[#c3f1d6] rounded-full flex-row gap-1'>
            ...
            <View className='flex flex-row justify-between px-5 pt-3'>
              ...
              <View className='flex flex-col gap-2 px-5'>
                <View className='flex flex-row gap-3'>
                  <Text className='text-green-500 font-semibold'>TestID</Text>
                  <Text className='font-extrabold'>:</Text>
                  <Text className='text-blue-600 font-semibold'>2D3E</Text>
                </View>
                <View className='flex flex-row gap-3'>
                  <Text className='text-green-500 font-semibold'>Dr.Name</Text>
                  <Text className='font-extrabold'>:</Text>
                  <Text className='text-blue-600 font-semibold'>Dr.Mike</Text>
                </View>
                <View className='flex flex-row gap-3'>
                  <Text className='text-green-500 font-semibold'>Test Name</Text>
                  <Text className='font-extrabold'>:</Text>
                  <Text className='text-blue-600 font-semibold'>BCD</Text>
                </View>
                <View className='flex flex-row gap-3'>
                  <Text className='text-green-500 font-semibold'>Upload Time</Text>
                  <Text className='font-extrabold'>:</Text>
                  <Text className='text-blue-600 font-semibold'>3:20pm</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          <View className='flex-row gap-9 px-3 pt-3'>
            ...
            <Text className='text-[#667085] text-lg'>Friday 2:20pm</Text>
          </View>
          <View className='pt-3 flex-row gap-5 px-2'>
            <View className='w-[160px] h-[50px] rounded-xl flex-row justify-between px-1 pt-2' style={{
                borderWidth:1,
                borderColor:'#C5C6CC',
                ...
                <View>
                        <Text className='text-md'>bloodCulture1.pdf</Text>
                        <Text className='font-light'>200 KB</Text>
                    </View>
            </View>
            ...
            <Text className='text-xl m-auto text-blue-500 font-light'>Remove</Text>
        </TouchableOpacity>
          </View>
        ...
        <View className='flex m-auto pt-3'>
            <Text className='font-bold text-lg'>Your Recent Tests</Text>
        </View>
          ...
          <View className='pt-4'>
            <View className='flex flex-row justify-between px-5 pt-3'>
              ...
              <View className='flex flex-col gap-2 px-2'>
                ...
                <View className='flex flex-row gap-3'>
                  <Text className='text-green-500 font-semibold'>Expected Time</Text>
                  <Text className='font-extrabold'>:</Text>
                  <Text className='text-blue-600 font-semibold'>4:00pm</Text>
                </View>
              </View>
...
>
  ...
  <TouchableOpacity>
    <Link href={'/Authentication'} className='text-green-700 capitalize underline'>Notify me</Link>
  </TouchableOpacity>
  </View>
  <TouchableOpacity className='w-[120px] h-[50px]' style={{borderRadius:10, borderWidth:1, borderColor:'blue'}}>
            <Text className='text-xl m-auto text-blue-500 font-light'>Cancel</Text>
        </TouchableOpacity>
