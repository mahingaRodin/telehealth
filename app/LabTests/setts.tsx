  ...
  return (
    <View className='w-[100%] h-[100%]'>
      <View className='flex flex-row justify-start gap-20 px-2 pt-6'>
        ...
        <Text className='text-xl font-bold top-1'>
          Settings</Text>
         </View>
        ...
        <View className='gap-4 px-2'>
          <Text className='text-lg font-bold px-5'>Account</Text>
          
          <View className='flex flex-row justify-between px-5'>
          <View className='flex flex-row gap-5'>
            <Feather name='user' size={25} color={'#2FAF64'}></Feather>
            <Text className='text-lg font-light'>Profile</Text>
          </View>
         ...
         <View className='gap-6 px-2 pt-7'>
          ...
          <View className='flex flex-row gap-5'>
            ...
            <Text className='text-lg font-light'>Ratings & Reviews</Text>
          </View>
          ...
          <View className='flex flex-row gap-5'>
            ...
            <Text className='text-lg font-light'>Help</Text>
          </View>
        ...
        <View className='flex flex-row justify-center '>
          <TouchableOpacity className='' onPress={()=>router.navigate('/Patient/PatientHome')}>
            <Text className='text-xl font-light'>Log out</Text>
          </TouchableOpacity>
        </View>
