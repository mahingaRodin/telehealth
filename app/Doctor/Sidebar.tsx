      ...
      <View style={styles.container}>
        <Animated.View style={[styles.sidebar, { left: sidebarAnimation }]}>
          <View className='flex flex-row justify-between'>
            ...
            <TouchableOpacity onPress={() => handleNavigation('/Doctor/profile')}>
          ...
          <View className='pt-9 flex flex-col gap-4'>
            ...
            >
              ...
              <Text className='text-lg font-light' style={{
            ...
            <TouchableOpacity
              className='flex flex-row gap-4 w-200 h-50 bg-white rounded-lg'
              style={{ elevation: 2 }}
              onPress={() => handleNavigation('/Doctor/Appoints')}
            >
            ...
            <TouchableOpacity
              className='flex flex-row gap-4 w-200 h-50 bg-white rounded-lg'
              style={{ elevation: 2 }}
              onPress={() => handleNavigation('/Doctor/Lab')}
            >
            ...
            <TouchableOpacity
              className='flex flex-row gap-4 w-200 h-50 bg-white rounded-lg'
              style={{ elevation: 2 }}
              onPress={() => router.navigate('/Doctor/settings')}
            >
