    ...
    >
      ...
      <View style={styles.container}>
        <Animated.View style={[styles.sidebar, { left: sidebarAnimation }]}>
          ...
          <View className='flex flex-col gap-4 pt-9'>
            <TouchableOpacity
              className='flex flex-row gap-4 bg-white rounded-lg w-220 h-50'
              style={{ elevation: 2 }}
              onPress={() => handleNavigation('/Home')}
            >
              <Ionicons name='home' size={30} color={'#2E63EB'} style={{ bottom: 5 }} />
              <Text className='text-lg font-light bottom-1' style={{
            ...
            <TouchableOpacity
              className='flex flex-row gap-4 bg-white rounded-lg w-220 h-50'
              style={{ elevation: 2 }}
              onPress={() => handleNavigation('/Patient/Appointments')}
            >
            ...
            <TouchableOpacity
              className='flex flex-row gap-4 bg-white rounded-lg w-220 h-50'
              style={{ elevation: 2 }}
              onPress={() => handleNavigation('/Patient/Doctors')}
            >
            ...
            <TouchableOpacity
              className='flex flex-row gap-4 bg-white rounded-lg w-220 h-50'
              style={{ elevation: 2 }}
              onPress={() => handleNavigation('/Patient/Lab')}
            >
            ...
            <TouchableOpacity
              className='flex flex-row gap-4 bg-white rounded-lg w-220 h-50'
              style={{ elevation: 2 }}
              onPress={() => router.navigate('/Patient/Settings')}
            >
          ...
          <View className='flex flex-row justify-between top-72'>
            <TouchableOpacity>
