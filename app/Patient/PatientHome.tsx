...
<SafeAreaView>
        <View className='flex fixed z-50 flex-row justify-between p-3'>
        <View>
        ...
        <View className='flex flex-row gap-4'>
          ...
          <Ionicons name='search-sharp' size={25} style={{color:Colors.colors.green}}></Ionicons>
           ...
           <TouchableOpacity onPress={()=>router.navigate('/Patient/notifications')}>
    ...
    <View className='flex flex-row justify-between px-4'>
        <View className='flex gap-2'>
            <CustomText className='text-lg'>Good Morning, <Text style={{color:Colors.colors.green}}>John Doe</Text> </CustomText>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <View className="flex flex-row gap-4 px-4">
            {Array.from({ length: 5 }).map((_, index) => (
              <View key={index} style={styles.doctor1} className="flex flex-row justify-around p-4 bg-gray-200">
...
<View className='pb-2 pl-5'>
    <CustomText style={{fontFamily:'Montserrat-Medium'}}>Click an event to see details
        ...
        {Array.from({ length: 5 }).map((_, index) => (
              <TouchableOpacity onPress={()=>router.navigate('/Patient/Details')} key={index} style={styles.doctor} className="flex flex-row justify-around p-2 bg-gray-200">
...
<ScrollView className="flex flex-row gap-5 px-3" showsHorizontalScrollIndicator={false} horizontal={true}>
        <View >
          <TouchableOpacity className="flex flex-row gap-3 pt-2" onPress={()=>router.navigate('/Patient/BookAppoint')}>
...
<View className='gap-3 justify-center items-center'>
    <CustomText className='text-2xl text-white'>Opened</CustomText>
    <View className='flex flex-row'>
        <Ionicons name='timer' size={30} color={'white'}></Ionicons>
        <CustomText className='text-lg text-white' style={{fontFamily:'Montserrat-Medium'}}>Opened</CustomText>
    </View>
</View>
<View>
    <CustomText className='pl-1 text-white' style={{fontFamily:'Montserrat-Medium'}}>"Experience compassionate,
